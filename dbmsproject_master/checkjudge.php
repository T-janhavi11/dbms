...
<div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">SWAMI HARI</h5>
      <p class="card-text">
          <h3> Judge details</h3>
        <ul>
        <li>  Name: GAURAV</li>
         <li> Judge ID: J0001</li>
         <li> Number for contact: 1233455678</li>
          <li>email: gaurav@gmail.com</li>
          <li>Does your client ID match to CA001 ?</li>
          ..Your case is handed over to Justice GAURAV
